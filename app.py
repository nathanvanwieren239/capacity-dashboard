"""
Manufacturing Capacity Dashboard - skeletal build for internal review.

Run:  streamlit run app.py

Data is synthetic. See synthetic_data.py for the column contracts, and
capacity_model.py for the math.
"""
...
week_start, week_end = st.sidebar.slider(
    "Week range", 1, 52, (wk_lo, wk_hi)
)
...
groups = sorted(
    {tuple(r) for r in c_agg[group_keys].drop_duplicates().to_numpy()}
)
